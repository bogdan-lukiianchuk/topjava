            ...
            <div class="shadow">
                <h3><spring:message code="meals.title"/></h3>
                                ...
                                <form id="filterForm" onsubmit="filter(); return false;">
                                    ...
                                    <button type="reset" onclick="clearFilter()"><spring:message code="meals.clearFilter"/></button>
                                </form>
                <div class="view-box">
                    <%--<hr>--%>
                    <%--<a href="meals/create"><spring:message code="meals.add"/></a>--%>
                    <%--<hr>--%>
<%--                        <a class="btn btn-info" data-toggle="modal" data-target="#editRow">
                    ...
                    <table class="table table-striped display" id="datatable">
                        ...
                        <c:forEach items="${meals}" var="meal">
                            ...
                            <tr class="${meal.exceed ? 'exceeded' : 'normal'}">
                                ...
                                <td><a class="btn btn-xs btn-danger delete" id="del${meal.id}">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="detailsForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input type="number" class="form-control" id="calories" name="calories" placeholder="<spring:message code="meals.caloriesDefault"/>">
                        </div>
                    </div>
